...
import NodJSIcon from "../assets/sponsors-icon/nodejs-icon.svg";
import MaterialIcon from "../assets/sponsors-icon/material-ui-1.svg";
import ViteIcon from "../assets/sponsors-icon/vitejs.svg";
        ...
        <Grid item xs={12} md={6}>
          <Box>
            ...
            >
              ...
              <Grid item>
                <img src={MaterialIcon} width={"50px"} height={"50px"} />
              </Grid>

              <Grid item>
                <img src={NodJSIcon} width={"50px"} height={"50px"} />
              </Grid>

              <Grid item>
                <img src={ViteIcon} width={"50px"} height={"50px"} />
              </Grid>
